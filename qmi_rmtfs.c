...
struct qmi_elem_info rmtfs_single_sim_tag_req_ei[] = {
	{
		.data_type = QMI_UNSIGNED_4_BYTE,
		.elem_len = 1,
		.elem_size = sizeof(uint32_t),
		.tlv_type = 1,
		.offset = offsetof(struct rmtfs_single_sim_tag_req, caller_id),
	},
	{}
};

struct qmi_elem_info rmtfs_single_sim_tag_resp_ei[] = {
	{
		.data_type = QMI_STRUCT,
		.elem_len = 1,
		.elem_size = sizeof(struct rmtfs_qmi_result),
		.tlv_type = 2,
		.offset = offsetof(struct rmtfs_single_sim_tag_resp, result),
		.ei_array = rmtfs_qmi_result_ei,
	},
	{
		.data_type = QMI_UNSIGNED_1_BYTE,
		...
		.elem_size = sizeof(uint8_t),
		.tlv_type = 16,
		.offset = offsetof(struct rmtfs_single_sim_tag_resp, single_sim_tag),
	},
	{
		.data_type = QMI_OPT_FLAG,
		.elem_len = 1,
		.elem_size = sizeof(bool),
		.tlv_type = 17,
		.offset = offsetof(struct rmtfs_single_sim_tag_resp, single_sim_tag_valid),
	},
	{}
};
