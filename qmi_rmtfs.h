...
#define QMI_RMTFS_ODM_GET_SINGLE_SIM_TAG  7

// sim

#define SIM_TAG_SINGLE  1
#define SIM_TAG_DUAL    2


#define SINGLE_SIM_FILE "/veid/modem/singlesim"
...
struct rmtfs_single_sim_tag_req {
	uint32_t caller_id;
};

struct rmtfs_single_sim_tag_resp {
	struct rmtfs_qmi_result result;
	uint8_t single_sim_tag;
	bool single_sim_tag_valid;
};

extern struct qmi_elem_info rmtfs_single_sim_tag_req_ei[];
extern struct qmi_elem_info rmtfs_single_sim_tag_resp_ei[];
